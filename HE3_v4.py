...
# ── Experimental data ─────────────────────────────────────────────────────────
acc  = [2.0, 0.4, 0.3, 2.4, 0.3, 0.3, 2.9, 0.5, 0.4]
vel  = [0.3, 0.3, 0.2, 0.4, 0.1, 0.3, 0.5, 0.3, 0.5]
disp = [0.007, 0.023, 0.006, 0.030, 0.006, 0.006, 0.010, 0.012, 0.021]  

labels = [
    "60 RPM – Pos 1",   "60 RPM – Pos 2",   "60 RPM – Pos 3",
    "300 RPM – Pos 1",  "300 RPM – Pos 2",  "300 RPM – Pos 3",
    "700 RPM – Pos 1", "700 RPM – Pos 2", "700 RPM – Pos 3",
]
rpm_labels = ['60 RPM', '300 RPM', '700 RPM']
Z95 = 1.96
